...
The new features added are google maps by which the user can select the location TO and From from google maps rather than typing in the location. The various error handling has also been done in this version.
...
PROJECT MOTIVATION
------------------
This is a modification of my old app and I am trying to reuse my old application and introduce google maps in this application.
...
-------------------
 ...
 �In future, I also plan to add a way in which this application can extract the names of the people from the contact list living in that Destination area.


PROJECT REPOSITORY
------------------

Travel Planner (https://github.com/hemakumar/TravelPlanner2.0)
